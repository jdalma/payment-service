...
class R2DBCPaymentOutboxRepository (
    ...
    companion object {
        private val INSERT_OUTBOX_QUERY = """
        ...
        private val UPDATE_OUTBOX_MESSAGE_AS_SENT_QUERY = """
          UPDATE outboxes
          SET status = 'SUCCESS'
        ...
        private val UPDATE_OUTBOX_MESSAGE_AS_FAILURE_QUERY = """
          UPDATE outboxes
          SET status = 'FAILURE'
          WHERE idempotency_key = :idempotencyKey
          AND type = :type
        ...
        private val SELECT_PENDING_PAYMENT_OUTBOX_QUERY = """
          SELECT * 
          FROM outboxes
